...
namespace CasparCg.AmcpClient.Commands.Mixer
{
    ...
    public class MixerChromaSetCommand : AbstractMixerLayerCommandWithSubCommand
    {
        ...
        /// <param name="channel">
        ///     <see cref="AbstractChannelCommand.Channel" />
        /// </param>
        /// <param name="layer">
        ///     <see cref="AbstractLayerCommand.Layer" />
        /// </param>
        /// <param name="enableChroma">
        ///     <see cref="EnableChroma" />
        /// </param>
        /// <param name="chroma">
        ///     <see cref="Chroma" />
        ...
        ///     <see cref="Transform" />
        /// </param>
        public MixerChromaSetCommand(int? channel = null, int? layer = null, bool? enableChroma = null, MixerChroma chroma = null,
            Transform transform = null)
        {
            this.Channel = channel;
            this.Layer = layer;
            this.EnableChroma = enableChroma;
            this.Chroma = chroma;
