...
namespace CasparCg.AmcpClient.Commands.Mixer.Common.Response
{
    public class MixerChromaGetCommandResponse : AmcpResponse
    {
        ...
        internal override void ProcessData(AmcpParsedData data)
        {
            ...
            double[] values =
                Converter.StringToDoubleArray(data.Data[1], " ", NumberStyles.AllowDecimalPoint, new CultureInfo("en-US"));

            this.IsChromaEnabled = Convert.ToBoolean(values[0]);
            this.Chroma = new MixerChroma(values[1], values[2], values[3], values[4], values[5], values[6], values[7],
