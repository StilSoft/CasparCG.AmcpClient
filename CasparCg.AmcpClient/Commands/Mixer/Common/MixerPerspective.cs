...
namespace CasparCg.AmcpClient.Commands.Mixer.Common
{
    ...
    public class MixerPerspective
    {
        ...
        ///     <see cref="BottomRightX" />
        /// </param>
        /// <param name="bottomRightY">
        ///     <see cref="BottomRightY" />
        /// </param>
        /// <param name="bottomLeftX">
        ///     <see cref="BottomLeftX" />
        /// </param>
        /// <param name="bottomLeftY">
        ///     <see cref="BottomLeftY" />
        /// </param>
        public MixerPerspective(double? topLeftX = null, double? topLeftY = null, double? topRightX = null,
            double? topRightY = null,
