...
namespace CasparCg.AmcpClient.Commands.Mixer.Common
{
    ...
    public class MixerChroma
    {
        ...
        /// <summary>
        /// How much to suppress spill by within 0.0-180.0. It works by taking all hue values within +- this value from target_hue and clamps
        /// it to either target_hue - this value or target_hue + this value depending on which side it is closest to.
        /// </summary>
        [Required]
        [Range(0.0, 180.0)]
        [NumberToStringCulture(CultureName)]
        ...
        /// <summary>
        /// Controls how much saturation should be kept on colors affected by spill_suppress within 0.0-1.0. Full saturation may not always
        /// be desirable to be kept on suppressed colors.
        /// </summary>
        [Required]
        [Range(0.0, 1.0)]
        [NumberToStringCulture(CultureName)]
        ...
        ///     <see cref="HueWidth" />
        /// </param>
        /// <param name="minSaturation">
        ///     <see cref="MinSaturation" />
        /// </param>
        /// <param name="minBrightness">
        ///     <see cref="MinBrightness" />
        /// </param>
        /// <param name="softness">
        ///     <see cref="Softness" />
        /// </param>
        /// <param name="spillSuppress">
        ///     <see cref="SpillSuppress" />
        /// </param>
        /// <param name="spillSuppressSaturation">
        ///     <see cref="SpillSuppressSaturation" />
        /// </param>
        /// <param name="showMask">
        ///     <see cref="ShowMask" />
        /// </param>
        public MixerChroma(double? targetHue = null, double? hueWidth = null, double? minSaturation = null,
            ...
            double? softness = null, double? spillSuppress = null, double? spillSuppressSaturation = null, bool? showMask = null)
        {
            ...
            this.SpillSuppress = spillSuppress;
            this.SpillSuppressSaturation = spillSuppressSaturation;
