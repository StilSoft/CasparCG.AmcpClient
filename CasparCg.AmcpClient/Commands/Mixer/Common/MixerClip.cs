...
namespace CasparCg.AmcpClient.Commands.Mixer.Common
{
    ...
    public class MixerClip
    {
        ...
        /// <summary>
        /// The new width, 1 = 1x the screen width, 0.5 = half the screen width. Higher and lower values allowed. Negative values flips the
        /// layer.
        /// </summary>
        [Required]
        [Range(0.0, 1.0)]
        ...
        /// <summary>
        /// The new height, 1 = 1x the screen height, 0.5 = half the screen height. Higher and lower values allowed. Negative values flips
        /// the layer.
        /// </summary>
        [Required]
        [Range(0.0, 1.0)]
