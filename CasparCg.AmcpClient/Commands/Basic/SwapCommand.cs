...
namespace CasparCg.AmcpClient.Commands.Basic
{
    ...
    public class SwapCommand : AbstractBaseCommand
    {
        ...
        public SwapCommand(int? channelA = null, int? channelB = null, bool? transforms = null)
            : this(channelA, null, channelB, null, transforms)
        {
        }

        public SwapCommand(int? channelA = null, int? layerA = null, int? channelB = null, int? layerB = null,
            bool? transforms = null)
        {
