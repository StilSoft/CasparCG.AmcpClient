...
namespace CasparCg.AmcpClient.Commands.Query.Common
{
    public class TemplateFileInfo : CasparFileInfo
    {
        ...
        public TemplateFileInfo(string fullName)
            : base(fullName)
        {
        }

        public TemplateFileInfo(string fileName, string filePath)
        ...
        public static TemplateFileInfo Parse(string data)
        {
            ...
            try
            {
                ...
                long size = long.Parse(values[0]);
                var lastUpdate = DateTime.ParseExact(values[1], "yyyyMMddHHmmss", CultureInfo.InvariantCulture,
                    DateTimeStyles.None);
                ...
                {
                    Size = size, LastUpdate = lastUpdate, TemplateType = templateType
                };
