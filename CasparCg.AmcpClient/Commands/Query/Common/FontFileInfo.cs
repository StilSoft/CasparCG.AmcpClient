...
namespace CasparCg.AmcpClient.Commands.Query.Common
{
    public class FontFileInfo : CasparFileInfo
    {
        ...
        public FontFileInfo(string fullName)
            : base(fullName)
        {
        }

        public FontFileInfo(string fileName, string filePath)
        ...
        public static FontFileInfo Parse(string data)
        {
            ...
            try
            {
                ...
                string fontName = values[0].Replace("\"", "");
                string fullName = values[1].Replace("\"", "");
